  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col md:flex-row h-full mt-5 gap-6">
          {/* Text */}
          <div className="w-full md:w-1/2 relative top-0 md:top-[10%]">
...
const ScrollStack = forwardRef<HTMLElement, ComponentRootProps>(
  ({ projects }, ref) => {
    const container = useRef(null);
    const { scrollYProgress } = useScroll({
      target: container,
    ...
    return (
      <ReactLenis root>
        <main className="bg-" ref={container}>
          <>
            {/* <section className="text-white h-[70vh] w-full bg- grid place-content-center">
